...
<div class="header ">
    ...
    <div class="header-three" style="background: red;"><!-- header-three -->
        <div class="container" style="background: red;">
                ...
                <div class="cd-dropdown-wrapper">
                    ...
                    <nav class="cd-dropdown" style="background: #dfdfdf">
                        ...
                        <ul class="cd-dropdown-content">
                            ...
                            <li><br></li>
                            <%for (String arrayList : (ArrayList<String>)request.getAttribute(Constants.DB_CATEGORIES)) {%>
                            <li class="has-children">
                                <a href="/products"><%=arrayList%>
                                </a>
                            </li>
                            <%}%>
            ...
            <div class="move-text">
                <div class="marquee"><a href="offers.jsp"> New collections are available here......
