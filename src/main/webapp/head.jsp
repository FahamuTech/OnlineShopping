...
<div class="header ">
    <nav class="navbar navbar-inverse" style="border-radius: 0">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown head-dpdn">
                    <a href="card.html" class="dropdown-toggle"><i class="fa fa-credit-card-alt" aria-hidden="true"></i>
                        Credit Card</a>
                </li>
                <li class="dropdown head-dpdn">
                    <a href="help.html" class="dropdown-toggle"><i class="fa fa-question-circle" aria-hidden="true"></i>
                        Help</a>
                </li>
            </ul>
        </div>
    ...
    <%--<div class="w3ls-header">--%>
        ...
        <%--&lt;%&ndash;<div class="w3ls-header-left">&ndash;%&gt;--%>
            <%--&lt;%&ndash;<p><a href="products.html">UPTO $50 OFF ON LAPTOPS | USE COUPON CODE LAPPY </a></p>&ndash;%&gt;--%>
        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
        <%----%>
    <%--</div>--%>
    ...
    <%--<div class="header-three"><!-- header-three -->--%>
        <%--<div class="container">--%>
            <%--<div class="menu">--%>
                ...
                <%--</div> <!-- .cd-dropdown-wrapper -->--%>
            <%--</div>--%>
            <%--&lt;%&ndash;<div class="move-text">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="marquee"><a href="offers.html"> New collections are available here...... <span>Get extra 10% off on everything | no extra taxes </span>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<span> Try shipping pass free for 15 days with unlimited</span></a></div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<script type="text/javascript" src="res/script/jquery.marquee.min.js"></script>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<script>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;$('.marquee').marquee({pauseOnHover: true});&ndash;%&gt;--%>
                    <%--&lt;%&ndash;//@ sourceURL=pen.js&ndash;%&gt;--%>
                <%--&lt;%&ndash;</script>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
        <%--</div>--%>
    <%--</div>--%>
