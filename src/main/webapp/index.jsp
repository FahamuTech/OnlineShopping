    ...
    <div id="kb" class="carousel kb_elastic animate_text kb_wrapper" data-ride="carousel" data-interval="6000"
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active"><!-- First-Slide -->
                <img src="res/img/5.jpg" alt="" class="img-responsive"/>
            ...
            <div class="item"> <!-- Second-Slide -->
                <img src="res/img/8.jpg" alt="" class="img-responsive"/>
                <div class="carousel-caption kb_caption kb_caption_right">
            ...
            <div class="item"><!-- Third-Slide -->
                <img src="res/img/3.jpg" alt="" class="img-responsive"/>
...
<div class="header ">
    ...
    <div class="header-three"><!-- header-three -->
        <div class="container">
            ...
            <div class="move-text">
                <div class="marquee"><a href="offers.html"> New collections are available here...... <span>Get extra 10% off on everything | no extra taxes </span>
                    <span> Try shipping pass free for 15 days with unlimited</span></a></div>
                <script type="text/javascript" src="res/script/jquery.marquee.min.js"></script>
                <script>
